...
public class BitCoinDao extends DAO {
    ...
    public int transcation(String fname) throws UserException {
        try {
            super.begin();
...
//            super.close();
    ...
    public int add(User u) throws UserException {
        int success = 0;
        try {
            super.begin();
            getSession().save(u);
            ...
            super.rollback();
            throw new UserException("Could not get user " + u.getName(), e);
        }
        return success;
    }
