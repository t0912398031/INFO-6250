...
public class ShoppingLaptopServlet extends HttpServlet {
    //Service method
    @Override
...
//        session.setAttribute("ans", ans);
        ...
        out.println("<input type='checkbox' name='laptop' value='apple' />Apple<br />"
                + "<input type='checkbox' name='laptop' value='asus' />Asus<br />"
                + "<input type='checkbox' name='laptop' value='hp' />HO<br />"
                + "<input type='checkbox' name='laptop' value='toshiba' />Toshiba<br />"
