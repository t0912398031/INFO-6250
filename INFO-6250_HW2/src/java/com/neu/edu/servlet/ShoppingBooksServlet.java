...
public class ShoppingBooksServlet extends HttpServlet {
    //Service method
    @Override
...
//        session.setAttribute("ans", ans);
        ...
        out.println("</head>");
        out.println("<body>");
        out.println("<a href='book'>Book</a><br/>");
        ...
        out.println("<input type='checkbox' name='book' value='java' />Java<br />"
                + "<input type='checkbox' name='book' value='oracle' />Oracle<br />"
                + "<input type='checkbox' name='book' value='uml' />UML<br />"
                + "<input type='checkbox' name='book' value='object' />Object<br />"
                + "<input type='checkbox' name='book' value='web' />Web<br />"
